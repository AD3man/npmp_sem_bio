function  [A_full, TT] = repressilator_S_PDE_as_func(naloziCelice,shraniCelice, p)
    ...
    load_conf = 0;
    % shranjevanje kon�ne konfiguracije?
    save_conf = 0;
    % fiksni robovi ali spremenljivi
    borderfixed = 0;
    % snemanje videa - �asovno potratno
    movie_on = 0;
    % Nalo�i pozicijo celic 0 = false, 1 = true? 
    nalozi_celice = naloziCelice;
    % Shrani pozicijo celic, �e je nalozi_celice = 0 oz �e shranitvene datoteke ni.
    ...
    stdDeviacijaKoncentracije=std(A_full,[],2);
