...
meje_od = [0.01,0.01,0.01,1]; 
meje_do = [1,10,50,4];
set(0,'DefaultFigureVisible','off')
opt_max_ampl_rez_10_80 = ga(@(x)params_as_func(x,2,10,0.8),4,[],[],[],[],meje_od,meje_do,[],[4],options);
opt_max_ampl_rez_5_80 = ga(@(x)params_as_func(x,2,5,0.8),4,[],[],[],[],meje_od,meje_do,[],[4],options);
opt_max_ampl_rez_10_20 = ga(@(x)params_as_func(x,2,10,0.2),4,[],[],[],[],meje_od,meje_do,[],[4],options);